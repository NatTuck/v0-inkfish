defmodule InkfishWeb.Staff.GradeColumnControllerTest do
  ...
  describe "index" do
    test "lists all grade_columns", %{conn: conn} do
      conn = get(conn, Routes.staff_grade_column_path(conn, :index))
  ...
  describe "new grade_column" do
    test "renders form", %{conn: conn} do
      conn = get(conn, Routes.staff_grade_column_path(conn, :new))
  ...
  describe "create grade_column" do
    test "redirects to show when data is valid", %{conn: conn} do
      conn = post(conn, Routes.staff_grade_column_path(conn, :create), grade_column: @create_attrs)
    ...
    test "renders errors when data is invalid", %{conn: conn} do
      conn = post(conn, Routes.staff_grade_column_path(conn, :create), grade_column: @invalid_attrs)
      assert html_response(conn, 200) =~ "New Grade_Column"
    end
  end
  ...
  describe "edit grade_column" do
    ...
    test "renders form for editing chosen grade_column", %{conn: conn, grade_column: grade_column} do
      conn = get(conn, Routes.staff_grade_column_path(conn, :edit, grade_column))
  ...
  describe "update grade_column" do
    ...
    test "redirects when data is valid", %{conn: conn, grade_column: grade_column} do
      conn = put(conn, Routes.staff_grade_column_path(conn, :update, grade_column), grade_column: @update_attrs)
      assert redirected_to(conn) == Routes.staff_grade_column_path(conn, :show, grade_column)

      conn = get(conn, Routes.staff_grade_column_path(conn, :show, grade_column))
    ...
    test "renders errors when data is invalid", %{conn: conn, grade_column: grade_column} do
      conn = put(conn, Routes.staff_grade_column_path(conn, :update, grade_column), grade_column: @invalid_attrs)
      assert html_response(conn, 200) =~ "Edit Grade_Column"
    end
  end
  ...
  describe "delete grade_column" do
    ...
    test "deletes chosen grade_column", %{conn: conn, grade_column: grade_column} do
      ...
      assert redirected_to(conn) == Routes.staff_grade_column_path(conn, :index)
